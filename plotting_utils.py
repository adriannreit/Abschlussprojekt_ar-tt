...
def plot_parameterstudie_vergleich(ergebnisse, battery_type: str, wert_col="benoetigte_Ah", label_col=None):
    ...
    ergebnisse : list
        Parametersätze
    battery_type : string
        Name des verwendeten Akkus, verwendet für die Beschriftung des Diagramms
    wert_col : string 
    ...
    ax.set_title(f"Parametervergleich: {wert_col}, {battery_type}")
